...
//    dijkstra2->findShortestPath(0, 3);
    auto graph = GraphReader::loadFromFile("C:\\Users\\Home\\CLionProjects\\SDIZO_2\\9.txt");
    auto dijkstra3 = new Dijkstra(graph->list);
    auto dijkstra4 = new Dijkstra(graph->matrix);
    dijkstra3->findShortestPath(0, 3);
    std::cout << std::endl;
    dijkstra4->findShortestPath(0,3);
